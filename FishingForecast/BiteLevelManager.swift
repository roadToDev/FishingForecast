...
struct BiteLevelManager {
    ...
    func calculateLevel() {
//        var forecast = ForecaDailyForecast(averageCloudiness: 70, dayLength: 260, date: "", sunRise: <#T##String#>, sunSet: <#T##String#>, minPressure: <#T##Int#>, precipitationProbability: <#T##Int#>, maxPressure: <#T##Int#>, minHumidity: 120, maxHumidity: 123, symbolCode: <#T##String#>, minTemperature: <#T##Int#>, thunderProbability: <#T##Int#>, maxTemperature: <#T##Int#>, uvIndex: <#T##Int#>, windDirectionInDegrees: <#T##Int#>, windDirection: <#T##String#>, windSpeed: <#T##Int#>, moonRise: <#T##String#>, moonSet: <#T##String#>, p: <#T##Double#>, moonPhase: 234)
